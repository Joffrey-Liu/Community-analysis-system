...
<hr>
<ul>
  <li><h4>Google Cloud Vision:</h4> <p>透過<a href="https://cloud.google.com/vision/?hl=zh-tw">Google Cloud Vision api</a> 我們能夠將使用者所上傳的照片進行物件分析，來得知使用者所拍照的內容為何．```export PATH=<maven-path>:$PATH;```
    </p>
  </li>
  <li><h4>資料搜集與分析方法:</h4>
    <p>
